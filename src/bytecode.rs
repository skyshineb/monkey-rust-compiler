...
impl Opcode {
    ...
    pub fn from_byte(byte: u8) -> Option<Opcode> {
        match byte {
            ...
            26 => Some(Opcode::Call),
            27 => Some(Opcode::ReturnValue),
            28 => Some(Opcode::Return),
            29 => Some(Opcode::Array),
            30 => Some(Opcode::Hash),
            31 => Some(Opcode::Index),
            32 => Some(Opcode::InvalidBreak),
            33 => Some(Opcode::InvalidContinue),
            34 => Some(Opcode::Nop),
            _ => None,
        }
    }
